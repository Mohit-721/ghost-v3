...
def test_router_initializes_with_openai(
    base_config: GhostConfig, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_get_provider_raises_without_api_key(
    base_config: GhostConfig, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_get_provider_for_different_tiers(
    base_config: GhostConfig, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_get_provider_invalid_tier(
    base_config: GhostConfig, monkeypatch: pytest.MonkeyPatch
) -> None:
